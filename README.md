# SAR-SUSPICIOUS-ACTIVITY-REPORT-MULTI-AGENT-SYSTEM
This is a multi agent RAG system used using LangGraph which makes automated SAR's for financial institutions which helps them in automating task.
